...
const u16 DecorGfx_UNUSED_NATU_DOLL[] = {
    OBJ_EVENT_GFX_UNUSED_NATU_DOLL
};

const u16 DecorGfx_UNUSED_MAGNEMITE_DOLL[] = {
    OBJ_EVENT_GFX_UNUSED_MAGNEMITE_DOLL
};

const u16 DecorGfx_UNUSED_PIKACHU2_DOLL[] = {
    OBJ_EVENT_GFX_UNUSED_PIKACHU_DOLL
};

const u16 DecorGfx_UNUSED_PORYGON2_DOLL[] = {
    OBJ_EVENT_GFX_UNUSED_PORYGON2_DOLL
};

const u16 DecorGfx_UNUSED_SQUIRTLE_DOLL[] = {
    OBJ_EVENT_GFX_UNUSED_SQUIRTLE_DOLL
};

const u16 DecorGfx_UNUSED_WOOPER_DOLL[] = {
